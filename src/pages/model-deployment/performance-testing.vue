  ...
  <div class="performance-testing-page">
    ...
    <el-card class="mt-4">
      ...
      <el-form :model="testForm" label-width="150px">
        ...
        <el-form-item>
          <el-button type="primary" :loading="testing" @click="startTest">
            开始测试
          </el-button>
        </el-form-item>
      </el-form>
    ...
    <el-card v-if="testResult" class="mt-4">
      ...
      <el-descriptions :column="3" border>
        ...
        <el-descriptions-item label="平均TPS">{{ testResult.avgTPS }} tokens/s</el-descriptions-item>
        <el-descriptions-item label="吞吐量">{{ testResult.throughput }} req/s</el-descriptions-item>
