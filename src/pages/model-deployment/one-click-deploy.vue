<template>
  <div class="one-click-deploy-page">
    <el-card>
      ...
      <div v-if="currentStep === 0">
        <el-form :model="form" label-width="150px">
          <el-form-item label="选择模型">
            <el-select v-model="form.modelName" placeholder="请选择要部署的模型" style="width: 100%">
      ...
      <div v-if="currentStep === 1">
        <el-form :model="form" label-width="150px">
          ...
          <el-form-item label="选择集群">
            <el-select v-model="form.cluster" placeholder="请选择集群">
      ...
      <div v-if="currentStep === 2">
        ...
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="集群">{{ form.cluster }}</el-descriptions-item>
          <el-descriptions-item label="算力规格">{{ form.gpuSpec }}</el-descriptions-item>
          <el-descriptions-item label="副本数">{{ form.replicas }}</el-descriptions-item>
          <el-descriptions-item label="服务能力">{{ form.capabilities.join(', ') }}</el-descriptions-item>
        </el-descriptions>
      ...
      <div class="mt-6 flex gap-3">
        ...
        <el-button v-if="currentStep < 2" type="primary" @click="currentStep++">
          下一步
        </el-button>
...
async function deploy() {
  ...
  const services = getStorage('deployment-services', [])
  const newService = {
  ...
  setStorage('deployment-services', services)
